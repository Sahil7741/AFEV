...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(FSLeft_A5_GPIO_Port, FSLeft_A5_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC1     ------> ADC2_IN2
    */
    HAL_GPIO_DeInit(FSRight_A4_GPIO_Port, FSRight_A4_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC2     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(FSMiddle_35_GPIO_Port, FSMiddle_35_Pin);
